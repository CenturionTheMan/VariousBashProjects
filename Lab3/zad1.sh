...
find linux-5.11.13/ -type f -name "mutex.c" -print  # find 'f' - file, 'name' - name of file, 
                                                    # 'print' - print the path of file in given format, 
                                                    # '%P' - print the relative path of file, '\n' - new line