...
executablesAmount=$(find linux-5.11.13/ -type f -executable | wc -l)                    # find 'f' - file, 'executable' - file is executable 
bashExecutablesAmount=$(find linux-5.11.13/ -type f -executable -name "*.sh" | wc -l)   # find 'f' - file, 'executable' - file is executable, 
                                                                                        # 'name' - name (pattern) of file,
                                                                                        # '*.sh' - file with extension .sh
echo "${bashExecutablesAmount}/${executablesAmount}"                                    # print the amount of bash executables and all executables